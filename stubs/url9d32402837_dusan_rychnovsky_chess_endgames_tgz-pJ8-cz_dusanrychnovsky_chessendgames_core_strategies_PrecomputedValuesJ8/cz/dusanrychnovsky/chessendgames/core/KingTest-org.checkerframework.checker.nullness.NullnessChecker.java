...
public class KingTest extends PieceTest {
    ...
    private static final @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull King king = new King(player);
