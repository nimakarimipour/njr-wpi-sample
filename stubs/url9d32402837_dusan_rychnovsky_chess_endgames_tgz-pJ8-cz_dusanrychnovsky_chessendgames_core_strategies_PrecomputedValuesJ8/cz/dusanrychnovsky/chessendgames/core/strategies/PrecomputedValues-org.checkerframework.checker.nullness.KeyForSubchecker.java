...
public class PrecomputedValues extends Strategy implements Serializable {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public void save( PrecomputedValues this,  File file) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public void save( PrecomputedValues this,  ObjectOutput out) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private   int walkthrough( PrecomputedValues this) {
        int result = 0;
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public   boolean evaluate( PrecomputedValues this,  Situation situation,  Player player) {
    ...
    private   int inc( PrecomputedValues this,   int value) {
    ...
    @org.checkerframework.dataflow.qual.Impure
    public  Move chooseMove( PrecomputedValues this,  Situation situation,  Player player) {
        Pair<Situation, Player> key = Pair.of(situation, player);
