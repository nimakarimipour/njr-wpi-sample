...
public class CLIAdapter {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public void run( CLIAdapter this) throws IOException {
        printIntroduction();
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private  Move getMove( CLIAdapter this,  Situation situation) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private  Situation setUpInitialSituation( CLIAdapter this) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private void setUpBlackRook( CLIAdapter this,  Situation situation) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private void setUpBlackKing( CLIAdapter this,  Situation situation) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private void setUpWhiteKing( CLIAdapter this,  Situation situation) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private  Position readPosition( CLIAdapter this) throws IOException {
        while (true) {
            String line = in.readLine();
            try {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private void printIntroduction( CLIAdapter this) throws IOException {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    private void printLine( CLIAdapter this,  String line) throws IOException {
        out.write(line);
        out.newLine();
        out.flush();
    }
